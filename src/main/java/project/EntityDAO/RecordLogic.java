...
public class RecordLogic {
	...
	public String addRecordToOPDCasePaper_Kayachiktsa_Department()
	{
		...
		opd_disease_medicine_case_paper.setRx3(constant.PIPPALI_CHURNA_1g_1g_x_5D);
		...
		opd_disease_medicine_case_paper.setRx2(constant.AVIPATTIKAR_CHURNA_1g_1g_x_5D);
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setC_o(constant.MALAVASHTAMBHA_KC);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.kayachikitsa);
		opd_disease_medicine_case_paper.setVyadhiName(constant.ANIDRA);

		opd_disease_medicine_case_paper.setRx1(constant.SARPAGANDHA_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.BALA_POWDER_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		...
		opd_disease_symptoms_improvement.setDepartment(constant.kayachikitsa);
		opd_disease_symptoms_improvement.setVyadhiName(constant.ANIDRA);

		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setC_o(constant.ANIDRA_KC);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.kayachikitsa);
		opd_disease_medicine_case_paper.setVyadhiName(constant.BRAMA);

		opd_disease_medicine_case_paper.setRx1(constant.SUTSHEKAR_RAS_VATI_2_2_x_5D);
		...
		opd_disease_symptoms_improvement.setDepartment(constant.kayachikitsa);
		opd_disease_symptoms_improvement.setVyadhiName(constant.BRAMA);

		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setC_o(constant.BRAMA_KC);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		...
		opd_disease_medicine_case_paper.setX_ray(constant.X_RAY_BIL_ANKLE_Jt_A_P_LATERAL);
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.vatajkas);
		opd_disease_symptoms_improvement.setC_o(constant.parshnirshul_KC);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setBiochemical(constant.S_CREATININE);
	...
	public String addRecordToOPDCasePaper_Panchakarma_Department()
	{
		...
		opd_disease_symptoms_improvement.setSymptoms(constant.vam_pad_shodh_pad_shul);
		opd_disease_symptoms_improvement.setVyadhiName(constant.vatrakta);
		opd_disease_symptoms_improvement.setC_o(constant.VATRAKTA_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_symptoms_improvement.setSymptoms(constant.sandhishool_kriyaalpata_malavirodh_6_8_months);
		opd_disease_symptoms_improvement.setVyadhiName(constant.SANDHIVAT);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.panchakarma);
		opd_disease_medicine_case_paper.setVyadhiName(constant.sthoulya);
		opd_disease_medicine_case_paper.setRx1(constant.AROGYAVARDHINI_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.GANDHARVAHAREETAKI_CHURNA_0_3g_x_5D);
		opd_disease_medicine_case_paper.setRx3(constant.MEDOHAR_VATI_2_2_x_5D);
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSerological("");
		opd_disease_medicine_case_paper.setBiochemical("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.sthoulya);
		opd_disease_symptoms_improvement.setC_o(constant.STHOULYA_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setRx3(constant.CHITRAK_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSerological("");
		opd_disease_medicine_case_paper.setBiochemical("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.aamvat);
		opd_disease_symptoms_improvement.setC_o(constant.AAMVAT_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setVyadhiName(constant.ANIDRA);
		opd_disease_medicine_case_paper.setRx1(constant.SARPAGANDHA_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.MANJISHTHA_CHURNA_2g_2g_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSerological("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.ANIDRA);
		opd_disease_symptoms_improvement.setC_o(constant.ANIDRA_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.akarma);
		opd_disease_medicine_case_paper.setVyadhiName(constant.PRUSHTHAVAT);
		...
		opd_disease_symptoms_improvement.setVyadhiName(constant.PRUSHTHAVAT);
		opd_disease_symptoms_improvement.setC_o(constant.PRUSHTHAVAT_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.panchakarma);
		opd_disease_medicine_case_paper.setVyadhiName(constant.KATIVAT);
		opd_disease_medicine_case_paper.setRx1(constant.YOGARAJ_GUGGUL_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.MAHAVATVIDHWANSA_RAS_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther(constant.KATI_BASTI_Dhanwantar_Tel);
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSerological("");
		opd_disease_medicine_case_paper.setBiochemical("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.KATIVAT);
		opd_disease_symptoms_improvement.setC_o(constant.KATIVAT_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.panchakarma);
		opd_disease_medicine_case_paper.setVyadhiName(constant.KARSHYA);
		opd_disease_medicine_case_paper.setRx1(constant.SHATAVARI_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.LAGHU_MALINI_VASANT_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan(constant.SNEHAN_SARVANGA_BALA_TEL);
		opd_disease_medicine_case_paper.setSerological("");
		...
		opd_disease_symptoms_improvement.setSymptoms(constant.krushata_angamard_kriyaalpata);
		opd_disease_symptoms_improvement.setVyadhiName(constant.KARSHYA);
		opd_disease_symptoms_improvement.setC_o(constant.KARSHYA_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.panchakarma);
		opd_disease_medicine_case_paper.setVyadhiName(constant.SARVANGMARDA);
		opd_disease_medicine_case_paper.setRx1(constant.SIMHANAD_GUGGUL_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.RASNADI_GUGGUL_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.SARVANGMARDA);
		opd_disease_symptoms_improvement.setC_o(constant.SARVANGMARDA_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setRx2(constant.BALA_POWDER_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx3(constant.LAGHU_SUTSHEKAR_VATI_2_2_x_5D);
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSerological("");
		opd_disease_medicine_case_paper.setBiochemical("");
		opd_disease_medicine_case_paper.setShirodhara(constant.SHIRODHARA_Brahmi_Tel); 
		...
		opd_disease_symptoms_improvement.setC_o(constant.NIDRANASH_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan(constant.SARVANGA_SNEHAN_Sahachar_Tel);
		opd_disease_medicine_case_paper.setSwedan(constant.SARVANGA_PETI_SWEDAN);
		opd_disease_medicine_case_paper.setSerological("");
		opd_disease_medicine_case_paper.setBiochemical("");
		opd_disease_medicine_case_paper.setShirodhara(""); 
		opd_disease_medicine_case_paper.setBasti(constant.KAL_BASTI_KRAM); 
		opd_disease_medicine_case_paper_Repos.save(opd_disease_medicine_case_paper);
		...
		opd_disease_symptoms_improvement.setSymptoms(constant.Sakashtha_Mal_Pravrutti_malavsthambh_udarshool);
		opd_disease_symptoms_improvement.setVyadhiName(constant.manyagatvat);
		opd_disease_symptoms_improvement.setC_o(constant.MANYAGATVAT_PK);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
	...
	public String addRecordToOPDCasePaper_Strirog_Department()
	{
		...
		opd_disease_medicine_case_paper.setDepartment(constant.strirog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.yonidah);
		opd_disease_medicine_case_paper.setRx1(constant.CHANDRAPRABHA_VATI_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.CHOPCHINI_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx3(constant.NAGA_GUTI_2_2_x_5D);
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		...
		opd_disease_symptoms_improvement.setDepartment(constant.strirog);
		opd_disease_symptoms_improvement.setSr_no(61);
		opd_disease_symptoms_improvement.setSymptoms(constant.Sakashtha_Mal_Pravrutti_malavsthambh_udarshool);
		opd_disease_symptoms_improvement.setVyadhiName(constant.yonidah);
		opd_disease_symptoms_improvement.setC_o(constant.YONIDAH_SR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.strirog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.RAKTPRADAR);
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.RAKTPRADAR);
		opd_disease_symptoms_improvement.setC_o(constant.RAKTPRADAR_SR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.strirog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.GRANTYARTAV);
		opd_disease_medicine_case_paper.setRx1(constant.TRIKATU_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.CHANDRAPRABHA_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSwedan("");
		...
		opd_disease_symptoms_improvement.setSymptoms(constant.Sakashtha_Mal_Pravrutti_malavsthambh_udarshool);
		opd_disease_symptoms_improvement.setVyadhiName(constant.GRANTYARTAV);
		opd_disease_symptoms_improvement.setC_o(constant.GRANTYARTAV);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setRx2(constant.AROGYAVARDHINI_GUTI_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setHematological(constant.CBC_ESR);
		opd_disease_medicine_case_paper.setSwedan("");
		...
		opd_disease_medicine_case_paper.setDepartment(constant.strirog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.STANYAKSHYA);
		opd_disease_medicine_case_paper.setRx1(constant.SHATAVARI_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.BALA_POWDER_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.STANYAKSHYA);
		opd_disease_symptoms_improvement.setC_o(constant.PCOD);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.strirog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.RAJONIVRUTTI);
		opd_disease_medicine_case_paper.setRx1(constant.CHANDRAPRABHA_VATI_2_2_x_5D);
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.RAJONIVRUTTI);
		opd_disease_symptoms_improvement.setC_o(constant.RAJONIVRUTTI_SR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.strirog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.kashtartav);
		opd_disease_medicine_case_paper.setRx1(constant.CHANDRAPRABHA_VATI_2_2_x_5D);
		...
		opd_disease_symptoms_improvement.setVyadhiName(constant.kashtartav);
		opd_disease_symptoms_improvement.setC_o(constant.KASHTARTAV_SR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.strirog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.yonikandu);
		opd_disease_medicine_case_paper.setRx1(constant.GANDHAK_RASAYAN_VATI_125mg_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.PATOLA_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx3(constant.KUTAJ_GHANA_VATI_2_2_x_5D);
		opd_disease_medicine_case_paper.setOther(constant.YONIDHAVAN_TRIPHALA_KWATH_YONIPICHU_NEEMTRIPHALA_TEL);
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSwedan("");
		opd_disease_medicine_case_paper.setSerological("");
		opd_disease_medicine_case_paper.setBiochemical("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.yonikandu);
		opd_disease_symptoms_improvement.setC_o(constant.YONIKANDU_SR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
	...
	public String addRecordToOPDCasePaper_Balrog_Department()
	{
		...
		opd_disease_medicine_case_paper.setVyadhiName(constant.PRATISHYAYA);
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.PRATISHYAYA);
		opd_disease_symptoms_improvement.setC_o(constant.PRATISHYAYA_BR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setRx2(constant.KUTAJ_GHANA_VATI_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx3(constant.SUNTHI_POWDER_125mg_125mg_x_5D);
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSwedan("");
		opd_disease_medicine_case_paper.setSerological("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.atisar);
		opd_disease_symptoms_improvement.setC_o(constant.ATISAR_BR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.balrog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.SHAYYA_MUTRA);
		opd_disease_medicine_case_paper.setRx1(constant.KRUMI_KUTHAR_RAS_1_1_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.ASHWAGANDHA_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx3("");
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		opd_disease_medicine_case_paper.setSwedan("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.SHAYYA_MUTRA);
		opd_disease_symptoms_improvement.setC_o(constant.SHAYYA_MUTRA_BR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.balrog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.KARSHYA);
		opd_disease_medicine_case_paper.setRx1(constant.LAGHU_MALINI_VASANT_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.ASHWAGANDHA_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setRx3(constant.YASHTIMADHU_CHURNA_1g_1g_x_5D);
		opd_disease_medicine_case_paper.setOther("");
		opd_disease_medicine_case_paper.setSnehan("");
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.KARSHYA);
		opd_disease_symptoms_improvement.setC_o(constant.KARSHYA_BR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setDepartment(constant.balrog);
		opd_disease_medicine_case_paper.setVyadhiName(constant.VISUCHIKA);
		opd_disease_medicine_case_paper.setRx1(constant.SUTSHEKAR_RAS_VATI_2_2_x_5D);
		opd_disease_medicine_case_paper.setRx2(constant.HINGVASHTAK_CHURNA_1g_1g_x_5D);
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.VISUCHIKA);
		opd_disease_symptoms_improvement.setC_o(constant.VISUCHIKA_BR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_symptoms_improvement.setSymptoms("");
		opd_disease_symptoms_improvement.setVyadhiName(constant.pandu);
		opd_disease_symptoms_improvement.setC_o(constant.PANDU_BR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_symptoms_improvement.setC_o(constant.UDARSHOOL_BR);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
	...
	public String addRecordToOPDCasePaper_Shalyatantra_Department()
	{
		...
		opd_disease_symptoms_improvement.setC_o(constant.PARIKARTIKA_ST);
		opd_disease_symptoms_improvement.setH_o(constant.NAD);
		opd_disease_symptoms_improvement.setUr(constant.avishesh);
		opd_disease_symptoms_improvement.setUdar(constant.soft);
		opd_disease_symptoms_improvement.setCvs(constant.S1S2_N);
		...
		opd_disease_medicine_case_paper.setBasti(constant.MATRA_BASTI_60mlErand_Tel_x_5D); 
		opd_disease_medicine_case_paper_Repos.save(opd_disease_medicine_case_paper);
		...
		opd_disease_medicine_case_paper.setRx1(constant.GOKSHUR_CHURNA_1g_1g_x_5D);
	...
	public String addRecordToOPDPanchakarmaProcedure(Patient p)
	{
		...
		else if(p.getDiagnosis().equalsIgnoreCase(constant.malabandha))
		{
			...
			opd_panch_procedure.setOld_no(p.getOld_no());
			opd_panch_procedure.setSex(p.getSex());
			opd_panch_procedure.setBasti(constant.Matra_Basti);
		...
		else if(p.getDiagnosis().equalsIgnoreCase(constant.vatrakta))
		{
			...
			opd_panch_procedure.setOld_no(p.getOld_no());
			opd_panch_procedure.setSex(p.getSex());
			opd_panch_procedure.setSnehan(constant.SNEHAN_SARVANGA_BALA_TEL);
			opd_panch_procedure.setRaktMokshan(constant.SIRAVEDH_1D);
		...
		if(discharge_date.isAfter(changeable))
		{
			...
			while(true)
			{
				...
				else
				{
					...
					ipd_panch_procedure.setSnehan(constant.SARVANGA_SNEHAN_Sahachar_Tel);
					ipd_panch_procedure.setSwedan(constant.sarvanga_peti_swedan);
					ipd_panch_procedure.setBasti(constant.KAL_BASTI_KRAM);
	...
	public String pathologicalTest_kaychikitsa_department_logic(Patient p)
	{
		...
		if(p.getDiagnosis().equalsIgnoreCase(constant.atisar))
		{
			pathologyTest.setMicrobiological(constant.STOOL_R_M);
		...
		{
			pathologyTest.setHematological(constant.CBC_ESR_M_P);
		...
		else if(p.getDiagnosis().equalsIgnoreCase(constant.pandu))
		{
			pathologyTest.setHematological(constant.CBC_ESR);
			pathologyTest.setBiochemical(constant.S_CREATININE);
			pathologyTest.setPathology_patient(p);
			pathologyTest.setPathology_record_no(pathology_Test_record_no);
			pathology_Test_record_no++;
